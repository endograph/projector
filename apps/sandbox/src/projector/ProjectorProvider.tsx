...
import type { SandboxClientInstance, SandboxClientSnapshot } from "@/src/types/display";
...
const EMPTY_CLIENT_SNAPSHOT: SandboxClientSnapshot = {
  instance: null,

...
} from "@projectors/sandbox-agent/src/attachments.js";
...
export type StoredSandboxAttachment = {
...
export type ResolvedSandboxAttachment = StoredSandboxAttachment & {
  url: string | null;
};
...
export function normalizeAttachment(attachment: StoredSandboxAttachment): StoredSandboxAttachment {
  return {
...
export async function resolveAttachmentUrls(
  ...
  attachments: readonly StoredSandboxAttachment[] | undefined,
): Promise<ResolvedSandboxAttachment[] | undefined> {
...
export function userContentPartsForFrame(
  content: string,
  attachments: readonly ResolvedSandboxAttachment[],
